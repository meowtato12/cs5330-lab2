...
Original file is located at
    https://colab.research.google.com/drive/1TFsSBqEjNhrtZHz59s0OhZPqfldUgHvJ
...
!pip install opencv-python-headless scikit-image scikit-learn seaborn matplotlib gradio
